...
CodeMirrorUI.prototype = {
  ...
  initialize: function(textarea, options, mirrorOptions) {
    ...
    this.buttonDefs = {
      'search': ["Search/Replace", "find_replace_popup", this.options.path + "../images/find.png", this.find_replace_popup],
      'searchClose': ["Close", "find_replace_popup_close", this.options.path + "../images/cancel.png", this.find_replace_popup_close],
      'searchDialog': ["Search/Replace", "find_replace_window", this.options.path + "../images/find.png", this.find_replace_window],
      'undo': ["Undo", "undo", this.options.path + "../images/arrow_undo.png", this.undo],
      'redo': ["Redo", "redo", this.options.path + "../images/arrow_redo.png", this.redo],
      'jump': ["Jump to line #", "jump", this.options.path + "../images/page_go.png", this.jump],
      'reindentSelection': ["Reformat selection", "reindentSelect", this.options.path + "../images/text_indent.png", this.reindentSelection],
      'reindent': ["Reformat whole document", "reindent", this.options.path + "../images/page_refresh.png", this.reindent],
      'about': ["About CodeMirror-UI", "about", this.options.path + "../images/help.png", this.about]
    };
